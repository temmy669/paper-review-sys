...
const SubmitForm: React.FC = () => {
  ...
  return (
    <Form
      method="post"
      action=""
      className="flex flex-col gap-9 px-20 pt-20 pb-16 items-center font-Montserrat"
    >
      <div className="flex flex-col gap-2">
        ...
        {selectedFile && (
          <div>
            ...
            {/* Optionally display additional information about the file */}
      ...
      <div className="flex gap-44">
        <Link to="/" onClick={handleSubmit}>
          <Button isAbsolute={false} isLight={false} name="Proceed" />
        </Link>
      </div>
    </Form>
  );
